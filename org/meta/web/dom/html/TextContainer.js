		...
		local:
		{
				draw: function draw(sheet)
				{
					...
					//
						...
						org.meta.web.dom.html.TextContainer.super.invoke('draw', this, sheet) ; // relegate call to org.meta.web.dom.html.Container
				...
				*/
				setTextStyle: function setTextStyle(properties)
				{
					...
					//
						...
						this.style.setRules(Component.createComponentIDSelector(this) + ' .text', o) ;
