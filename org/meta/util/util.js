				...
				global:
				{
						create: function create(pattern)
						{
							...
							// preconditions
								...
								Meta.assert(Meta.isString(pattern) && pattern.length > 0, 'Illegal Argument: argument for formal parameter `pattern` must be non-empty string.') ;
